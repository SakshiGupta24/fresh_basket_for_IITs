...
<head>
<meta charset="utf-8">
<title>Order Spices Online</title>
...
<?php
$s="select * from items where category='6'";
		$con=mysqli_connect("127.0.0.1","root","","projdb"); 
		if($con)
		{
			...
			while($fr=mysqli_fetch_array($rs))
			{
				...
				<div class="col-sm-3">
						<form action="<?php echo "menu_spices.php?it=$a&rate=$d&img=$c&nam=$b";  ?>" method="post">
