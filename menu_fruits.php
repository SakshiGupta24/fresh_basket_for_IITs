...
<head>
<meta charset="utf-8">
<title>Order Fruits Online</title>
...
<?php
$s="select * from items where category='1'";
		$con=mysqli_connect("127.0.0.1","root","","projdb"); 
		if($con)
		{
...
?>
				...
				<div class="col-sm-3">
						<form action="<?php echo "menu_fruits.php?it=$a&rate=$d&img=$c&nam=$b";  ?>" method="post">
