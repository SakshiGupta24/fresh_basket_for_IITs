...
<head>
<meta charset="utf-8">
<title>Order Pulses Online</title>
...
<?php
$s="select * from items where category='5'";
		$con=mysqli_connect("127.0.0.1","root","","projdb"); 
		if($con)
		{
			...
			while($fr=mysqli_fetch_array($rs))
			{
				...
				<div class="col-sm-3">
						<form action="<?php echo "menu_pulses.php?it=$a&rate=$d&img=$c&nam=$b";  ?>" method="post">
